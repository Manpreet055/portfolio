...
const ContactCard = ({ Icon = () => null, title, link, text, color = "" }) => {
  return (
    <div className="flex flex-col h-40 justify-center border border-gray-300 dark:border-gray-600 shadow-lg hover:shadow-md transitions p-6 rounded-2xl  w-full items-center">
