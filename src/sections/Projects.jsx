...
const Projects = () => {
  ...
  return (
    <section
      className=" sm:px-6 mt-5 sm:mt-10 mb-10 w-full flex  md:px-10 flex-col justify-center"
      id="projects"
    >
      <div className="flex relative w-full px-4 sm:px-0  mt-10 items-center justify-between">
        ...
        <button
          className="absolute right-1  shadow-effect text-xs sm:text-base p-3 transitions rounded-lg theme text-nowrap font-medium group flex items-center gap-2"
