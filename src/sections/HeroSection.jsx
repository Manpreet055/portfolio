...
const HeroSection = () => {
  ...
  return (
    <section className="px-3 sm:px-3" id="hero">
      <div className="lg:mx-16 mt-2 sm:mt-6 overflow-hidden rounded-3xl relative flex items-start min-h-150vh px-4 sm:px-6 xl:px-32 py-8 sm:py-16 bg-gray-100 dark:bg-gray-800">
